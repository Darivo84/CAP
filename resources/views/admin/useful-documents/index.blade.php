...
@section('content')
    <section>
        <div class="admin-bread-crumbs">
            <h2 class="content-heading" style="margin: 0; color: #fff;">
                ...
                <i class="fa fa-angle-right" aria-hidden="true"></i> Useful Documents
            </h2>
        </div>

        <div class="section-content">
            <div class="add-box">
                <a href="{{route('get_useful_documents_create')}}" class="input-btn" id="add_file">
                    ...
                    <tr>
                        ...
                        <td style="width: 100px;text-align: right;">
                            ...
                            <div class="tooltip">
                                ...
                                <a href="{{ asset($value->path)}}" target="_blank" class="input-btn blue-btn">
                                    <i class="fa fa-eye" aria-hidden="true"></i>
                                    <p class="display_none">VIEW</p>
                                </a>
                            </div>

                            <div class="tooltip">
                                <span class="tooltiptext">download</span>
                                <a href="{{ route('post_download_pdf', $value->id)}}" class="input-btn blue-btn">
                                    <i class="fa fa-download" aria-hidden="true"></i>
                                    <p class="display_none">download</p>
                                </a>
                            </div>
        ...
        <div id="openModal_file_delete" class="modalDialog">
            <div>
                ...
                <form action="'/dashboard/useful-documents/delete" id="remove_event_form" method="post">
    ...
    <script>
        ...
        $('.file_delete_modal').on('click', function () {
            ...
            console.log(data_id)
            var url = "/dashboard/useful-documents/delete/" + data_id;
