...
@section('content')
    <section>
        <div class="admin-bread-crumbs">
            <h2 class="content-heading" style="margin: 0; color: #fff;">
                ...
                <i class="fa fa-angle-right" aria-hidden="true"></i> Industries
            </h2>
        </div>

        <div class="section-content">
            <div class="add-box">
                <a href="{{route('get_industries_create')}}" class="input-btn" id="add_file">
                    ...
                    <tr>
                        ...
                        <td style="width: 100px;text-align: right;">
                            ...
                            <div class="tooltip">
                                ...
                                <a href="{{url('/dashboard/industries/update/' . $value->id)}}"
    ...
    <script>
        ...
        $('.file_delete_modal').on('click', function () {
            ...
            console.log(data_id)
            var url = "/dashboard/industries/delete/" + data_id;
        ...
        $("#industries_view_all").addClass('active');
    </script>
@endsection