...
@section('content')
    <section>
        <div class="admin-bread-crumbs">
            <h2 class="content-heading" style="margin: 0; color: #fff;">
                ...
                <i class="fa fa-angle-right" aria-hidden="true"></i> Careerrs
            </h2>
        </div>

        <div class="section-content">
            <div class="add-box">
                <a href="{{route('get_careers_create')}}" class="input-btn" id="add_file">
                    ...
                    <tr>
                        ...
                        <td style="width: 100px;text-align: right;">
                            ...
                            <div class="tooltip">
                                ...
                                <a href="{{url('/dashboard/careers/update/' . $value->id)}}"
        ...
        <div id="openModal_file_delete" class="modalDialog">
            <div>
                ...
                <form action="/dashboard/careers/delete" id="remove_event_form" method="post">
    ...
    <script>
        ...
        $('.file_delete_modal').on('click', function () {
            ...
            console.log(data_id)
            var url = "/dashboard/careers/delete/" + data_id;
