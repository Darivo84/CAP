...
@section('content')
    <section>
        ...
        <div class="section-content">
            <div class="add-box">
                <a href="{{route('get_services_create')}}" class="input-btn" id="add_file">
            ...
            <table cellspacing='0' id="table">
                ...
                @foreach($services as $key => $value)
                    <tr>
                    @if(isset($service_cats[$value->id]))
                        <td>{{$service_cats[$value->id]}}</td>
                        @else
                         <td>The service Category has been deleted!</td>
                    @endif
                        <td>{{$value->title}}</td>
                        ...
                        <td style="width: 100px;text-align: right;">
                            ...
                            <div class="tooltip">
                                ...
                                <a href="{{url('/dashboard/services/update/' . $value->id)}}" class="input-btn blue-btn">
        ...
        <div id="openModal_file_delete" class="modalDialog">
            <div>
                ...
                <form action="/dashboard/services/delete" id="remove_event_form" method="post">
    ...
    <script>
        ...
        $('.file_delete_modal').on('click', function () {
            ...
            console.log(data_id)
            var url = "/dashboard/services/delete/" + data_id;
