...
@section('content')
    <section>
        <div class="admin-bread-crumbs">
            <h2 class="content-heading" style="margin: 0; color: #fff;">
                ...
                <i class="fa fa-angle-right" aria-hidden="true"></i> Service Categories
            </h2>
        </div>

        <div class="section-content">
            <div class="add-box">
                <a href="{{route('get_service_categories_create')}}" class="input-btn" id="add_file">
            ...
            <table cellspacing='0' id="table">
                ...
                <tbody>
                @foreach($service_cats as $key => $value)
                    <tr>
                        <td>{{$value->name}}</td>
                        ...
                        <td style="width: 100px;text-align: right;">
                            ...
                            <div class="tooltip">
                                ...
                                <a href="{{url('/dashboard/service-categories/update/' . $value->id)}}"
                                   class="input-btn blue-btn">
        ...
        <div id="openModal_file_delete" class="modalDialog">
            <div>
                ...
                <form action="/dashboard/service-categories/delete" id="remove_event_form" method="post">
    ...
    <script>
        ...
        $('.file_delete_modal').on('click', function () {
            ...
            console.log(data_id)
            var url = "/dashboard/service-categories/delete/" + data_id;
